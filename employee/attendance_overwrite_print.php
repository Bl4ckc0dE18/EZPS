	...
	while($row = $query->fetch_assoc()){
		$image = '<img src="../evidence/' . $row['evidence'] . '" width="300px" height="300px" />';
							...
							<tr> 
								...
								<td width="50%"><b>'.$row['firstname'].' '.$row['lastname'].'</b></td>
							...
							<tr> 
								...
								<td width="50%"><b>'.$row['status'].'</b></td> 
							</tr>
							<tr> 
								<td colspan="4" align ="center"><b>Comment</b></td>
							</tr>
							<tr> 
								<td colspan="4" align ="center"><b>'.$row['comment'].'</b></td>
							</tr>
							...
							<tr> 
								<td colspan="4" align ="center"><b>Evidence</b></td>
							</tr>
							<tr> 
								<td colspan="4" align ="center"><b><br><br><br>'.$image.'<br><br><br></b></td>
							</tr>
