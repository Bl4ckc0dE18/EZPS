    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="attendance_overwrite_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="photo" class="col-sm-3 control-label">Photo Evidence </label>
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
			  <form class="form-horizontal" method="POST" action="attendance_overwrite_edit.php" enctype="multipart/form-data">
				...
				<div class="form-group">
                    <label for="edit_photo" class="col-sm-3 control-label">Photo Evidence </label>
