    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Add GSIS</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="gsis_add.php">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_percent" class="col-sm-3 control-label">Percent</label>
                  	...
                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="edit_percent" name="edit_percent" required>
                  	</div>
                </div>
          	</div>
          	<div class="modal-footer">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="sss_delete.php">
            		...
            		<div class="text-center">
	                	<p>DELETE GSIS</p>
	                	<h2 id="gsis_percent" class="bold"></h2>
	            	</div>
          	</div>
          	<div class="modal-footer">
            	<button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
