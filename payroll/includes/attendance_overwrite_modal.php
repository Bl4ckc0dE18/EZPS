    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="attendance_overwrite_edit.php">
            		<input type="hidden" id="attid" name="id">
                
                
					<div class="form-group">
                    <label for="edit_status" class="col-sm-3 control-label">Change</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
					<textarea class="form-control" name="edit_comment" id="edit_comment"  style="resize: none;"></textarea>
                    </div>
                </div>
          	</div>
